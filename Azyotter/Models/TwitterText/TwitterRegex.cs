...
{
    public static class TwitterRegex
    {
        ...
        private const string LATIN_ACCENTS_CHARS = "\\u00c0-\\u00d6\\u00d8-\\u00f6\\u00f8-\\u00ff" + // Latin-1
        ...
        private const string HASHTAG_ALPHA_NUMERIC_CHARS = "0-9\\uff10-\\uff19_" + HASHTAG_ALPHA_CHARS;
        ...
        **/
        ...
        public static readonly Regex VALID_HASHTAG = new Regex("(^|[^&" + HASHTAG_ALPHA_NUMERIC_CHARS + "])(#|\uFF03)(" + HASHTAG_ALPHA_NUMERIC + "*" + HASHTAG_ALPHA + HASHTAG_ALPHA_NUMERIC + "*)", RegexOptions.IgnoreCase);
        ...
        public static readonly Regex INVALID_HASHTAG_MATCH_END = new Regex("^(?:[#＃]|://)");
        public static readonly Regex RTL_CHARACTERS = new Regex("[\u0600-\u06FF\u0750-\u077F\u0590-\u05FF\uFE70-\uFEFF]");

        public static readonly Regex AT_SIGNS = new Regex("[" + AT_SIGNS_CHARS + "]");
        public static readonly Regex VALID_MENTION_OR_LIST = new Regex("([^a-z0-9_!#$%&*" + AT_SIGNS_CHARS + "]|^|RT:?)(" + AT_SIGNS + "+)([a-z0-9_]{1,20})(/[a-z][a-z0-9_\\-]{0,24})?", RegexOptions.IgnoreCase);
        ...
        public static readonly Regex VALID_REPLY = new Regex("^(?:" + UNICODE_SPACES + ")*" + AT_SIGNS + "([a-z0-9_]{1,20})", RegexOptions.IgnoreCase);
        public const int VALID_REPLY_GROUP_USERNAME = 1;

        public static readonly Regex INVALID_MENTION_MATCH_END = new Regex("^(?:[" + AT_SIGNS_CHARS + LATIN_ACCENTS_CHARS + "]|://)");

        public static readonly Regex VALID_URL = new Regex(VALID_URL_PATTERN_STRING, RegexOptions.IgnoreCase);
